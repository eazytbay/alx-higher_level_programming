...
class TestBaseDocs(unittest.TestCase):
    """A Test that checks the style and documentation of Base class"""
    @classmethod
    def setUpClass(cls):
        """The doc tests set up"""
        cls.base_funcs = inspect.getmembers(Base, inspect.isfunction)

    def test_pep8_conformance_base(self):
        """This particular test models/base.py conforms to PEP8."""
        pep8style = pep8.StyleGuide(quiet=True)
        outcome = pep8style.check_files(['models/base.py'])
        self.assertEqual(result.total_errors, 0,
                         "Found code style errors (and warnings).")

    def test_pep8_conformance_test_base(self):
        """This Test checks if tests/test_models/test_base.py conforms to PEP8."""
        pep8style = pep8.StyleGuide(quiet=True)
        outcome = pep8style.check_files(['tests/test_models/test_base.py'])
        self.assertEqual(result.total_errors, 0,
                         "Code style errors found (and warnings).")

    def test_module_docstring(self):
        """This Tests checks for the module docstring"""
        self.assertTrue(len(base.__doc__) >= 1)

    def test_class_docstring(self):
        """This Test checks for the docstring Base class"""
        self.assertTrue(len(Base.__doc__) >= 1)

    def test_func_docstrings(self):
        """This Test confirms the presence of docstrings in all functions"""
        for perf in self.base_funcs:
            self.assertTrue(len(perf[1].__doc__) >= 1)


class TestBase(unittest.TestCase):
    """This Tests checks if the Base class is functional"""
    def test_too_many_args(self):
        """This test for too many args to init"""
    ...
    def test_nb_private(self):
        """This Tests nb_objects as a private instance attribute"""
        b = Base(3)
    ...
    def test_to_json_string(self):
        """Test to confirm regular to json string"""
    ...
    def test_from_json_string(self):
        """This Test regular from_json_string"""
...
{"id": 2, "width": 2, "height": 3, "x": 4, "y": 0}]'
    ...
    def test_fjs_empty(self):
        """This empty string test from_json_string"""
