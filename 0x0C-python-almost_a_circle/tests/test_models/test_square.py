#!/usr/bin/python3
"""
This Test for the Square class
"""
...
class TestSquareDocs(unittest.TestCase):
    """This tests the style and documentation of the square class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_square(self):
        """This Tests to confirm if models/square.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_rectangle(self):
        """This Test to confirm that tests/test_models/test_square.py conforms to PEP8."""
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_module_docstring(self):
        """This Tests to confirm the presence of a module docstring"""
        self.assertTrue(len(square.__doc__) >= 1)

    def test_class_docstring(self):
        """This Tests for the presence of a docstring class"""
        self.assertTrue(len(Square.__doc__) >= 1)

    def test_func_docstrings(self):
        """This Tests for the presence of docstrings in all functions"""
        for perf in self.sq_funcs:
...
class TestSquare(unittest.TestCase):
    ...
    def test_update_args(self):
        ...
        sqr = Square(1, 0, 0, 1)
        self.assertEqual(str(sqr), "[Square] (1) 0/0 - 1")
        sqr.update(89)
        self.assertEqual(str(sqr), "[Square] (89) 0/0 - 1")
        sqr.update(89, 2)
        self.assertEqual(str(sqr), "[Square] (89) 0/0 - 2")
        sqr.update(89, 2, 3)
        self.assertEqual(str(sqr), "[Square] (89) 3/0 - 2")
        sqr.update(89, 2, 3, 4)
    ...
    def test_update_args_setter(self):
        ...
        with self.assertRaises(TypeError):
            sqr.update(1, "hello")
        with self.assertRaises(TypeError):
            sqr.update(1, 1, "hello")
        with self.assertRaises(TypeError):
            sqr.update(1, 1, 1, "hello")
    ...
    def test_update_too_many_args(self):
        ...
        sqr = Square(1, 0, 0, 1)
        sqr.update(1, 1, 1, 1, 2)
        self.assertEqual(str(sqr), "[Square] (1) 1/1 - 1")
    ...
    def test_update_kwargs(self):
        ...
        self.assertEqual(str(sqr), "[Square] (1) 0/0 - 1")
        sqr.update(size=10)
        self.assertEqual(str(sqr), "[Square] (1) 0/0 - 10")
        sqr.update(size=11, x=2)
        self.assertEqual(str(sqr), "[Square] (1) 2/0 - 11")
    ...
    def test_mix_args_kwargs(self):
        ...
        sqr = Square(1, 0, 0, 1)
        sqr.update(2, 2, 2, 2, size=3, x=3, y=3, id=3)
        self.assertEqual(str(sqr), "[Square] (2) 2/2 - 2")
    ...
    def test_to_dict(self):
        ...
        sqr = Square(1, 1, 1, 1)
        sqr.update(**d4)
        self.assertEqual(str(sqr), str(self.s4))
        self.assertNotEqual(sqr, self.s4)
    ...
    def test_load_from_file_no_file(self):
        """This Checks the use of load_from_file with no file"""
        try:
    ...
    def test_load_from_file_empty_file(self):
        """This Checks the use of load_from_file with empty file"""
        try:
            os.remove("Square.json")
        except:
            pass
