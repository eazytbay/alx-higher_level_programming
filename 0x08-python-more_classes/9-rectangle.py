...
""" Dedinition of a class rectangle"""


class Rectangle:
    """ Spells out  the properties of a rectangle"""
    ...
    def width(self, value):
        """Sets the property for the width"""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Returns the rectangle that's the biggest based on the area"""
    ...
    def square(cls, size=0):
        """ Returns a new rectangle instance that has equal sides"""
